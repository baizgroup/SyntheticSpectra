function param = initializeModelInputs_3_11_2022()
%%  Basics
...
param.input.xo.Dw(1,1)= 3;	%linewidth (sigma) in cm-1
...
param.input.lb.w(1,1)   = param.input.xo.w(1,1)/1645;%0.99;
...
param.input.ub.w(1,1)   = param.input.xo.w(1,1)/1705;%1.04;
